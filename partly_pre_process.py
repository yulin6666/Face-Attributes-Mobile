...
if __name__ == "__main__":
    ensure_folder(PARTLY_IMG_DIR)

    print('loading {}...'.format(partly_pickle_file))
    with open(partly_pickle_file, 'rb') as file:
    ...
    for item in tqdm(items):
        try:
            ...
            filename = os.path.join(PARTLY_IMG_DIR, filename)
